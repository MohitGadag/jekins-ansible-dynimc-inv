...
pipeline {
  ...
  stages {
    ...
    stage('CheckOutCode'){
      steps{
        git credentialsId: 'c6c4b606-3681-439d-9ced-f9215e163305', url: 'https://github.com/MohitGadag/jekins-ansible-dynimc-inv.git'
      }
    }
     
    //Using Terrafrom to create the Servers
